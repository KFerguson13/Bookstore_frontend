    ...
    return (
        ...
        <section className="bg-black text-light mt-2 pt-3 font-weight-bold">
                ...
                <div className = "d-sm-flex align-items-center justify-content-center">
                    ...
                    <img className ="img-fluid w-25" src = "https://ak.picdn.net/shutterstock/videos/7297471/thumb/1.jpg"></img>
                </div> 
...
<section className = "m-2">
  <Row className = "mb-2">
    <Col className = 'col-7 d-flex justify-content-center text-center align-items-center p-4' 
